package worldgeneratorextension.shpop.structure;
...
public class StrongholdPieces {
    ...
    private static StrongholdPiece findAndCreatePieceFactory(Class<? extends StructurePiece> pieceClass, List<StructurePiece> pieces, NukkitRandom random, int x, int y, int z, BlockFace orientation, int genDepth) {
 ...
 //\\ StrongholdPiece::generateAndAddPiece(SHStartPiece *,std::vector<std::unique_ptr<StructurePiece,std::default_delete<StructurePiece>>,std::allocator<std::unique_ptr<StructurePiece,std::default_delete<StructurePiece>>>> &,Random &,int,int,int,int,int)
    private static StructurePiece generateAndAddPiece(StartPiece start, List<StructurePiece> pieces, NukkitRandom random, int x, int y, int z, BlockFace orientation, int genDepth) {
        if (genDepth > 50) {
            return null;
    ...
    public static class Straight extends StrongholdPiece {
        ...
        public boolean postProcess(ChunkManager level, NukkitRandom random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateSmallDoor(level, random, boundingBox, StrongholdPiece.SmallDoorType.OPENING, 1, 1, 6);
    ...
    public static class StraightStairsDown extends StrongholdPiece {
        ...
        public boolean postProcess(ChunkManager level, NukkitRandom random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateSmallDoor(level, random, boundingBox, this.entryDoor, 1, 7, 0);
            this.generateSmallDoor(level, random, boundingBox, StrongholdPiece.SmallDoorType.OPENING, 1, 1, 7);
    ...
    public static class PortalRoom extends StrongholdPiece {
        ...
        public boolean postProcess(ChunkManager level, NukkitRandom random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateSmallDoor(level, random, boundingBox, StrongholdPiece.SmallDoorType.GRATES, 4, 1, 0);
